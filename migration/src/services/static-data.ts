...
// Knockout stage fixtures — empty until activation (generateKnockoutFixtures → knockout-fixtures.json)
export const loadStaticKnockoutFixtures = () =>
  fetchJson<Fixture[]>('knockout-fixtures.json').catch(() => [] as Fixture[]);
